const LOCALES = {
    ja: {
        ...
        deletePswPointTooltip:"このPSWポイントを削除",
        addPswSlotTooltip:    "+Slot: 30°スロット追加（最大12スロット）",
        deletePswSlotTooltip: "-Slot: 最後のスロットを削除",
        setPswPoseTooltip:    "+MLP: 0°スロット専用。現在の全レイヤーポーズをまとめて登録（マルチレイヤーポーズ）",
        setSlpPoseTooltip:    "+SLP: 0°スロット専用。レイヤーツリーで選択中のレイヤーのポーズを登録（シングルレイヤーポーズ）",
        clearPswPoseTooltip:  "-LP: このスロットのポーズをクリア",
        maxPswSlotsReached:   "最大12スロットです",
        noLayerSelectedForSlp:"SLP: レイヤーツリーでポーズを登録するレイヤーを選択してください",
        bgColorTooltip:       "背景色",
        ...
        kfExporting:    "エクスポート中...",
        kfGifExportBtn:    "🎞️ GIF",
        kfGifExportTooltip:"アニメーションを透過 GIF 画像としてエクスポート",
        kfGifExporting:    "GIF変換中...",
        kfFpsLabel:       "FPS",
        ...
        kfGoToZeroBtn:    "0",
        kfGoToZeroTooltip:"フレーム 0 に移動",
        kfClearBtn:       "New",
        kfClearTooltip:   "キーフレームを全削除して初期化（確認あり）",
        kfAddCamBtn:      "+CK",
        kfAddCamTooltip:  "現在フレームにカメラをキーフレーム登録",
        kfDelCamBtn:      "-CK",
        kfDelCamTooltip:  "現在フレームのカメラキーフレームを削除",
        kfMoveKeyBtn:     "↔",
        kfMoveKeyTooltip: "キー移動モード: ONのとき、タイムライン上でキーフレームをドラッグ移動（プレイヘッドOFF）",
    ...
    en: {
        ...
        deletePswPointTooltip:"Delete this PSW point",
        addPswSlotTooltip:    "+Slot: Add 30° slot (max 12 slots)",
        deletePswSlotTooltip: "-Slot: Delete last slot",
        setPswPoseTooltip:    "+MLP: Slot 0 only. Register all layer poses (Multi-Layer Pose)",
        setSlpPoseTooltip:    "+SLP: Slot 0 only. Register the selected layer's pose (Single-Layer Pose)",
        clearPswPoseTooltip:  "-LP: Clear this slot's pose",
        maxPswSlotsReached:   "Maximum 12 slots",
        noLayerSelectedForSlp:"SLP: Select a layer in the layer tree to register its pose",
        ...
        kfGifExportBtn:    "🎞️ GIF",
        kfGifExportTooltip:"Export animation as transparent GIF image",
        kfGifExporting:    "Encoding GIF...",
        kfFpsLabel:       "FPS",
        ...
        kfGoToZeroBtn:    "0",
        kfGoToZeroTooltip:"Go to frame 0",
        kfClearBtn:       "New",
        kfClearTooltip:   "Clear all keyframes (confirm required)",
        kfAddCamBtn:      "+CK",
        kfAddCamTooltip:  "Record camera keyframe at current frame",
        kfDelCamBtn:      "-CK",
        kfDelCamTooltip:  "Delete camera keyframe at current frame",
        kfMoveKeyBtn:     "↔",
        kfMoveKeyTooltip: "Key move mode: when ON, drag keyframes on the timeline (playhead disabled)",
    ...
    zh: {
        ...
        deletePswPointTooltip: "删除此PSW点位",
        addPswSlotTooltip:     "+Slot: 添加30°槽位（最多12个）",
        deletePswSlotTooltip:  "-Slot: 删除最后一个槽位",
        setPswPoseTooltip:     "+MLP: 仅限0°插槽。将当前所有图层姿势一并注册（多图层姿势）",
        setSlpPoseTooltip:     "+SLP: 仅限0°插槽。将图层树中选中图层的姿势注册（单图层姿势）",
        clearPswPoseTooltip:   "-LP: 清除此槽位的姿势",
        maxPswSlotsReached:    "最多12个槽位",
        noLayerSelectedForSlp: "SLP: 请在图层树中选择要注册姿势的图层",
        bgColorTooltip:       "背景颜色",
        ...
        kfExporting:    "导出中...",
        kfGifExportBtn:    "🎞️ GIF",
        kfGifExportTooltip:"将动画导出为透明GIF图像",
        kfGifExporting:    "GIF编码中...",
        kfFpsLabel:       "FPS",
        ...
        kfGoToZeroBtn:    "0",
        kfGoToZeroTooltip:"跳转到第 0 帧",
        kfClearBtn:       "New",
        kfClearTooltip:   "清除所有关键帧（需确认）",
        kfAddCamBtn:      "+CK",
        kfAddCamTooltip:  "在当前帧记录摄像机关键帧",
        kfDelCamBtn:      "-CK",
        kfDelCamTooltip:  "删除当前帧的摄像机关键帧",
        kfMoveKeyBtn:     "↔",
        kfMoveKeyTooltip: "键帧移动模式：开启时，在时间轴上拖动可移动关键帧（播放头禁用）",
